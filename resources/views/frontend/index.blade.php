...
<section class="text-white position-relative z-1">
    ...
    <div class="absolute-full z-1">
        <div class="carousel h-100" data-items="1" data-autoplay="true" data-infinite="true" data-fade="true">
    ...
    <div class="position-relative py-4 z-1035">
        <div class="container py-lg-5 py-4">
        <div class="text-center">
            <h1 class="h1 fw-600 mb-2">পছন্দের স্কুল / কলেজ এখন আরো কাছে!</h1>
            <p class="fs-16 mb-4 pb-lg-3">৬৪ জেলা থেকে খুঁজে নিন আপনার পছন্দের স্কুল / কলেজ আবেদন, ভর্তি আর অজানা সকল
                তথ্য !
            </p>
            <form class="mw-1000px mx-auto w-100" action="{{ route('search_institute') }}" method="GET">
                <div class="search-wrapper">
                    <div class="row gx-0 align-items-center">
                        <div class="col-md border-end">
                            <input type="text" name="institute_key" class="form-control border-0"
                                placeholder="প্রতিষ্ঠানের নাম লিখুন...">
                        </div>
                        <div class="col-md border-end">
                            <select class="select w-100" name="location" id="location">
                        ...
                        <div class="w-md-fit px-3 py-10px d-grid">
                            <button type="submit" class="btn-primary px-5"><span>খুজুন</span></button>
                        </div>
                    </div>
                </div>
            </form>
...
<section class="category-section py-4">
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-lg-8">
                <h3 class="h3 fw-600 mb-1 text-secondary text-center">Browse Education Board</h3>
                <p class="text-center mb-4 fs-16">নির্দিষ্ট ক্যাটাগরি হতে পছন্দের শিক্ষা বোর্ডটি নির্বাচন করুন !!</p>
                <div class="row g-sm-3 g-2">
                    @foreach(App\Models\Board::orderByDesc('id')->get() as $row)
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="single-category position-relative">
                            <a href="{{ route('board_details',$row->board_slug) }}" class="absolute-full"></a>
                            <img class="lazyload img-contain" width="80" height="80"
                                src="{{ asset('public/uploads/'.$row->logo) }}" alt="Icon">
                            <h5 class="mb-0"><a href="{{ route('board_details',$row->board_slug) }}">{{$row->board_name ?? ''}}</a>
                            </h5>
                        </div>
                    </div>
                    @endforeach
            ...
            <div class="col-lg-4">
                <h3 class="h3 fw-600 mb-1 text-secondary text-center">এক ক্লিকে বিভাগের সব স্কুল / কলেজ</h3>
                <p class="text-center mb-4 fs-16" style="visibility: hidden;">hide content</p>
                <div class="map">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g id="Dhaka">
                            <a href="https://sc.banglastudent.com/division-details?slug=%E0%A6%A2%E0%A6%BE%E0%A6%95%E0%A6%BE-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97"
                                xlink:href="https://sc.banglastudent.com/division-details?slug=%E0%A6%A2%E0%A6%BE%E0%A6%95%E0%A6%BE-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97">
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-805.061,792.43 -810.275,786.251
                      -805.062,792.43 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-833.156,747.247 -834.51,744.351
                      -834.411,741.069 -834.51,744.351 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-807.381,773.7 -811.339,754.971
                      -813.174,750.337 -811.34,754.971 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-737.482,896.89 -739.8,898.743
                      -737.481,896.89 -741.344,890.035 -744.431,887.14 -744.432,887.14 -741.344,890.035 ">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-864.532,705.154 -873.125,694.146
                      -864.533,705.154 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-788.939,836.454 -792.51,835.778
                      -794.249,834.234 -792.511,835.778 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-766.445,867.444 -765.286,871.596
                      -766.444,867.444 -767.409,865.32 -770.114,861.555 -767.41,865.32 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-805.352,799.863 -801.199,795.809
                      -798.786,792.237 -798.787,792.237 -801.2,795.809 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-789.714,830.757 -788.166,827.572
                      -784.981,822.938 -788.169,827.572 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-873.125,694.146 -873.704,692.121
                      -862.892,663.93 -873.705,692.121 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-885.482,354.796 -878.822,361.362
                      -864.919,353.349 -878.822,361.361 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-771.947,470.456 -771.947,470.456
                      -772.046,465.628 -773.106,461.381 -772.046,465.629 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-891.469,334.232 -900.061,332.109
                      -891.469,334.233 -890.792,343.019 -885.482,354.796 -890.792,343.018 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-862.698,659.296 -863.084,657.461
                      -866.077,648.483 -863.085,657.461 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                      ...
                      -532.228,388.201 -532.905,390.421 -535.125,393.8 -536.962,397.662 -539.276,405.965 -539.276,405.965 -536.962,397.663 ">
                                ...
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-832.48,362.81 -852.368,356.245
                      -832.48,362.81 -816.041,362.81 -816.041,362.81 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-777.839,504.632 -778.416,501.833
                      -778.416,501.833 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-871.949,646.148 -871.002,646.359
                      -866.077,648.483 -871.001,646.359 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-924.402,629.068 -923.437,624.048
                      -923.437,624.048 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-769.533,584.764 -769.823,578.585
                      -772.719,576.075 -769.823,578.586 "></polygon>
                                <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" d="M-532.135,385.112l-0.095,3.089L-532.135,385.112
                      z"></path>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-578.738,694.438 -579.052,693.762
                      -579.052,693.763 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-570.846,672.136 -572.007,667.212
                      -572.007,667.213 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-552.309,657.655 -552.31,657.655
                      -546.134,661.709 -545.456,661.898 -546.133,661.709 "></polygon>
                                <rect x="-501.047" y="578.667" fill="#103466" stroke="#fff" stroke-width="2"
                                    stroke-miterlimit="10" width="0" height="2.635"></rect>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-489.074,571.731 -483.177,574.813
                      -489.073,571.73 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-502.882,583.316 -502.881,583.316
                      -503.302,583.158 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-570.091,714.823 -570.846,713.747
                      -576.349,708.05 -570.846,713.747 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-491.487,466.015 -491.487,466.016
                      -489.943,454.044 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-572.777,701.486 -572.777,701.484
                      -573.26,699.844 -575.385,697.334 -573.26,699.844 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-575.385,697.334 -578.379,695.21
                      -578.379,695.211 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                                    points="-745.205,902.394 -745.108,903.746
                      -743.759,905.096 -744.073,906.518 -743.758,905.096 -745.108,903.744 -745.204,902.394 -743.758,899.689 -743.759,899.689 ">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-752.091,922.474 -751.77,922.089
                      -751.77,922.089 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-750.032,933.867 -747.811,935.894
                      ...
                      -745.205,927.301 -744.143,928.943 -745.204,927.301 -747.039,926.723 -752.254,926.144 -753.604,925.467 -753.604,925.469 ">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-747.136,913.785 -745.302,914.849
                      -744.338,915.91 -745.302,914.847 -747.135,913.785 -748.006,911.758 -748.006,911.758 ">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-773.492,487.833 -774.554,483.393
                      -773.492,487.834 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-666.521,848.426 -668.55,848.039
                      -668.551,848.039 -666.521,848.426 -663.337,847.942 -661.597,849.101 -663.337,847.942 ">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-728.021,880.96 -730.531,883.567
                      -732.074,884.392 -730.53,883.567 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-661.597,849.101 -661.5,853.059
                      -661.5,853.059 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-717.496,864.935 -717.265,864.644
                      -717.497,864.935 -720.393,871.209 -721.853,873.236 -720.392,871.209 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-780.153,851.418 -785.27,840.51
                      -787.3,837.419 -785.271,840.51 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-740.763,967.076 -740.763,967.078
                      -739.895,969.009 -736.613,970.746 -739.894,969.008 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-475.654,509.17 -477.875,513.417
                      -479.166,515.252 -477.875,513.418 "></polygon>
                                <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                                    d="M-472.76,501.544l-2.896,7.626L-472.76,501.544z"></path>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-472.76,529.348 -473.05,532.146
                      -476.522,534.658 -473.05,532.148 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-635.724,846.591 -635.724,846.591
                      -636.484,847.748 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-455.765,624.733 -456.44,623.864
                      -455.766,624.732 -455.863,626.76 -456.732,632.069 -456.731,632.07 -455.863,626.761 ">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-462.234,591.715 -460.786,591.039
                      ...
                      -463.878,597.218 -463.878,597.218 -463.779,593.356 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-461.558,607.452 -461.365,604.556
                      ...
                      -451.807,576.751 -451.807,576.75 -455.476,579.936 -461.175,583.412 -462.525,584.956 -462.228,585.343 -462.524,584.957 ">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-482.702,559.663 -485.794,567.482
                      -487.432,569.027 -485.794,567.483 "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-617.094,778.335 -626.939,773.121
                      -634.469,770.417 -639.972,770.417 -640.552,772.446 -638.331,775.729 -631.766,782.583 -628.003,785.382 -624.045,786.541
                      -620.277,784.706 -619.118,782.101 -614.969,783.741 -607.342,789.342 -609.077,784.32 ">
                                </polygon>
                                <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" d="M-576.638,726.007l2.123-2.315l-1.545-2.605
                      ...
                      l5.021,0.097l1.833-2.8L-576.638,726.007z"></path>
                            ...
                            <g class="dhaka-dev">
                                <path fill="#fff" d="M-740.959,648.055v37.748c1.223,2.447,2.961,3.669,5.214,3.669c3.218,0,6.531-1.963,9.943-5.889
                          ...
                          L-740.959,648.055L-740.959,648.055z"></path>
                                <path fill="#fff" d="M-695.873,648.055v56.479l-5.214-5.406v-40.064c0-1.674-0.322-3.188-0.965-4.538
                          ...
                          c0.644,3.861,1.771,6.629,3.38,8.304h3.861l5.311,5.405L-695.873,648.055L-695.873,648.055z">
                                </path>
                                <path fill="#fff"
                          ...
                          c-3.282,1.835-6.758,4.04-10.427,6.612c9.01,3.8,15.704,9.816,20.082,18.055h0.191L-654.844,660.026L-654.844,660.026z">
                                ...
                                <path fill="#fff" d="M-610.529,648.055v56.479l-5.214-5.406v-40.064c0-1.674-0.323-3.188-0.966-4.538
                          ...
                          c0.643,3.861,1.77,6.629,3.379,8.304h3.861l5.311,5.405L-610.529,648.055L-610.529,648.055z">
                                </path>
                            </g>
                        </g>

                        <g id="Khulna">
                            <a href="https://sc.banglastudent.com/division-details?slug=%E0%A6%96%E0%A7%81%E0%A6%B2%E0%A6%A8%E0%A6%BE-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97"
                                xlink:href="https://sc.banglastudent.com/division-details?slug=%E0%A6%96%E0%A7%81%E0%A6%B2%E0%A6%A8%E0%A6%BE-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97a">
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-740.763,967.078 -740.763,967.076
                        ...
                        -736.613,970.746 -739.895,969.009 	"></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-913.866,1132.747 -918.694,1129.947
                        ...
                        -916.667,1142.692 -910.391,1146.071 -907.881,1142.111 -909.039,1135.934 	"></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-907.881,1142.113 -907.881,1142.111
                        -907.881,1142.111 	"></polygon>
                            ...
                            c0,0.712,0.041,1.423,0.125,2.134c0.083,0.712,0.167,1.192,0.251,1.443c0.46,1.004,1.443,1.568,2.949,1.694L-880.583,894.838z">
                                ...
                                <path fill="#fff" d="M-878.512,942.907c-0.627-0.837-1.317-1.686-2.07-2.541c-0.753-0.858-1.538-1.674-2.354-2.447
                            ...
                            C-893.186,930.975-893.781,930.796-894.451,930.671z"></path>
                                <path fill="#fff" d="M-849.71,894.838v37.088l-3.64-3.389v-20.081c0-1.256-0.449-2.354-1.35-3.295
                            ...
                            L-849.71,894.838L-849.71,894.838z"></path>
                                <path fill="#fff" d="M-816.638,894.838v37.778l-2.761-1.758l0.251-3.702c0.042-3.975-0.878-8.116-2.761-12.425
                            ...
                            l-3.45-3.514h34.2l3.641,3.514L-816.638,894.838L-816.638,894.838z"></path>
                                <path fill="#fff" d="M-803.587,894.838v36.711l-3.389-3.514v-26.043c0-1.088-0.209-2.071-0.627-2.949
                        ...
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-858.547,704.768 -864.532,705.154
                      -864.532,705.154 "></polygon>
                        <rect x="-801.926" y="789.195" fill="#103466" stroke="#fff" stroke-width="2"
                            stroke-miterlimit="10" width="0" height="6.275"></rect>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-635.722,846.591 -635.724,846.591
                      ...
                      -634.469,843.502 -633.406,846.785 -631.671,856.053 -629.931,854.991 -625.2,849.198 -622.014,846.012 -621.725,844.371 "></polygon>
                        ...
                        <g id="Barishal">
                            <a href="https://sc.banglastudent.com/division-details?slug=%E0%A6%AC%E0%A6%B0%E0%A6%BF%E0%A6%B6%E0%A6%BE%E0%A6%B2-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97"
                                xlink:href="https://sc.banglastudent.com/division-details?slug=%E0%A6%AC%E0%A6%B0%E0%A6%BF%E0%A6%B6%E0%A6%BE%E0%A6%B2-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97">
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                                ...
                                -610.139,1102.046 -608.402,1103.205 -606.375,1098.088 -603.094,1097.316 -604.25,1093.743 	">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                                ...
                                -628.29,1070.38 -628.677,1075.689 -627.423,1075.689 -626.262,1073.373 -617.284,1068.063 	">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-555.496,980.304 -564.67,971.905
                                ...
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-652.136,1084.668 -655.711,1088.724
                                ...
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-597.492,986.291 -600.294,983.2
                                ...
                                -594.5,997.104 -594.016,998.743 -591.699,1003.379 -592.182,998.068 -594.5,991.793 	">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-532.035,1035.913 -533.194,1037.361
                                ...
                                -525.953,1041.706 -523.54,1039.582 -522.094,1035.431 -521.512,1030.604 -521.706,1026.453 	">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-618.056,868.796 -612.457,868.699
                                ...
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-523.057,1020.178 -522.187,1015.543
                                ...
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-590.444,980.208 -590.831,977.794
                                -591.699,975.381 -593.245,974.607 -594.5,987.835 -593.245,986.387 -590.348,984.648 	">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-637.944,849.97 -641.516,852.095
                                ...
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-640.165,1072.698 -642.868,1074.917
                                ...
                                "></polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-615.548,906.738 -612.36,905.579
                            ...
                            <g class="barishal-dev">
                                <path fill="#fff" d="M-709.711,967.242v36.898l-1.944-2.321c-0.125-0.376-0.283-0.764-0.472-1.16
                                ...
                                <path fill="#fff" d="M-667.478,959.461c-1.129-1.004-2.384-1.997-3.765-2.979c-1.38-0.982-2.949-1.955-4.707-2.919
                                ...
                                <path fill="#fff" d="M-626.25,967.242v36.962l-3.642-3.577l0.252-22.528c0-1.464-0.796-3.282-2.385-5.459
                                ...
                                <path fill="#fff" d="M-613.386,967.242v36.711l-3.389-3.514v-26.043c0-1.089-0.209-2.071-0.627-2.949
                                    ...
                                    c0.419,2.511,1.15,4.31,2.195,5.396h2.511l3.452,3.515H-613.386L-613.386,967.242z">
                                </path>
                                <path fill="#fff" d="M-576.738,967.242v37.088l-3.639-3.389V980.86c0-1.257-0.451-2.354-1.351-3.295
                        ...
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-712.283,859.624 -710.548,856.922
                      ...
                      -716.34,863.486 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-721.853,873.236 -725.606,878.45
                      -728.021,880.96 -725.606,878.45 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-664.397,842.825 -666.716,844.369
                      -668.551,848.039 -668.55,848.039 -666.716,844.371 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-649.819,846.785 -647.019,849.487
                      ...
                      -654.552,843.115 -661.308,841.571 -654.552,843.115 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-667.197,861.941 -664.882,858.176
                      ...
                      -672.314,863.776 -669.224,863.39 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-699.635,843.502 -701.566,846.979
                      -703.112,851.226 -701.566,846.979 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-685.347,842.729 -684.094,844.468
                      -685.347,842.729 -687.087,841.956 -689.402,841.571 -687.087,841.958 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-682.933,851.997 -683.416,846.301
                      -684.094,844.468 -683.416,846.303 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-733.427,885.112 -732.074,884.392
                      -733.427,885.112 -736.998,885.884 -744.432,887.14 -744.431,887.14 -736.998,885.886 ">
                        </polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-747.232,908.475 -744.143,906.835
                      -744.073,906.518 -744.143,906.835 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-739.991,963.505 -738.156,959.451
                      -737.676,956.072 -737.676,956.072 -738.156,959.451 "></polygon>
                        <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" d="M-740.763,967.076l0.772-3.571L-740.763,967.076z
                      "></path>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-742.503,899.111 -743.758,899.689
                      -743.758,899.689 -742.503,899.111 -740.38,899.207 -739.8,898.743 -740.379,899.207 ">
                        </polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-751.77,922.089 -745.398,917.841
                      -751.769,922.087 "></polygon>
                        <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" d="M-753.604,924.309l1.515-1.835L-753.604,924.309z
                      "></path>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-747.811,931.936 -750.131,932.901
                      -750.131,932.901 -747.811,931.936 -745.784,932.709 -744.338,932.128 -745.784,932.707 ">
                        </polygon>


                        <g id="Chittagong">
                            <a href="https://sc.banglastudent.com/division-details?slug=%E0%A6%9A%E0%A6%9F%E0%A7%8D%E0%A6%9F%E0%A6%97%E0%A7%8D%E0%A6%B0%E0%A6%BE%E0%A6%AE-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97"
                                xlink:href="https://sc.banglastudent.com/division-details?slug=%E0%A6%9A%E0%A6%9F%E0%A7%8D%E0%A6%9F%E0%A6%97%E0%A7%8D%E0%A6%B0%E0%A6%BE%E0%A6%AE-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97">
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-318.77,1190.48 -318.288,1185.46
                                ...
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-483.184,1019.694 -485.308,1011.585
                                ...
                                -497.28,979.533 -493.032,982.235 -487.722,981.946 -483.474,980.016 -479.132,977.119 -477.102,971.905 -479.323,967.563 	">
                                </polygon>
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-179.264,1236.436 -186.699,1213.652
                                ...
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-423.52,951.341 -427.865,953.658
                            ...
                            <g class="chittagong-dev">
                                <path fill="#fff"
                                    d="M-322.196,987.242h-21.649c-0.252,3.474,2.719,6.149,8.91,8.033c6.066,1.925,9.016,4.309,8.849,7.152
                                ...
                                <path fill="#fff"
                                    d="M-312.282,987.242v18.826c0,2.553,0.919,3.828,2.761,3.828c2.426,0,4.434-0.586,6.025-1.758
                                ...
                                <path fill="#fff" d="M-255.113,987.242h-6.401v37.652l-3.954-4.832c0.042-6.275,0.104-10.981,0.189-14.119
                                ...
                                <path fill="#fff" d="M-261.201,1026.213c-0.252-0.168-0.899-1.191-1.945-3.075c-1.256-2.175-1.986-3.43-2.197-3.766
                                ...
                                <path fill="#fff" d="M-248.59,987.242v36.711l-3.389-3.514v-26.043c0-1.089-0.21-2.071-0.628-2.949
                                    ...
                                    c0.418,2.511,1.149,4.31,2.195,5.396h2.512l3.451,3.515H-248.59L-248.59,987.242z">
                                </path>
                                <path fill="#fff" d="M-208.927,987.242h-6.339v36.898l-1.38-1.381c-1.883-7.11-5.146-11.421-9.79-12.927
                        ...
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-556.365,659.585 -552.31,657.655
                      ...
                      -518.906,591.715 -514.177,590.074 -507.223,580.517 -504.427,582.737 -503.302,583.158 -504.427,582.736 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-575.385,686.714 -571.135,675.516
                      -570.846,672.136 -571.136,675.516 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-526.533,628.402 -525.664,632.747
                      -526.532,628.402 -524.698,622.996 -522.285,620.679 -524.698,622.995 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-519.582,597.991 -519.294,596.929
                      -520.161,592.487 -519.295,596.928 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-530.973,647.903 -538.89,658.91
                      ...
                      -526.725,638.346 -525.664,632.747 -526.726,638.346 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-513.306,609.093 -514.85,613.92
                      -513.305,609.093 -517.36,606.68 -515.816,603.396 -517.361,606.68 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-571.909,665.378 -572.007,667.212
                      -572.007,667.212 -571.908,665.378 -569.883,662.386 -567.177,660.262 -569.883,662.385 ">
                        </polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-579.052,693.761 -579.052,693.762
                      -578.666,691.734 -575.385,686.714 -578.669,691.734 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                            points="-569.495,717.513 -572.681,717.896
                      -575.191,719.152 -572.68,717.898 -569.494,717.513 -569.011,716.354 -570.091,714.823 -569.012,716.354 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-572.777,701.486 -572.777,701.486
                      -572.97,703.127 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-574.515,723.689 -576.638,726.007
                      -574.514,723.691 -576.059,721.084 -575.191,719.152 -576.06,721.084 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-578.379,695.21 -578.738,694.438
                      -578.38,695.209 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-576.349,708.05 -574.514,706.216
                      -572.97,703.127 -574.515,706.216 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-576.638,726.007 -581.274,729
                      -583.107,731.8 -581.273,729.001 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-567.177,660.262 -564.38,659.489
                      -558.008,659.779 -564.381,659.488 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-502.881,583.316 -502.881,583.316
                      ...
                      -499.404,575.302 -501.238,576.364 -499.404,575.303 -495.348,574.916 -491.776,573.661 -489.074,571.731 -489.074,571.73 "></polygon>
                        ...
                        <g id="Sylhet">
                            <a href="https://sc.banglastudent.com/division-details?slug=%E0%A6%B8%E0%A6%BF%E0%A6%B2%E0%A7%87%E0%A6%9F-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97"
                                xlink:href="https://sc.banglastudent.com/division-details?slug=%E0%A6%B8%E0%A6%BF%E0%A6%B2%E0%A7%87%E0%A6%9F-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97">
                                <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                            ...
                            <g class="sylhet-dev">
                                <path fill="#fff" d="M-412.344,475.735c-1.129-1.004-2.385-1.997-3.766-2.98c-1.38-0.981-2.949-1.955-4.706-2.918
                                ...
                                <path fill="#fff" d="M-346.957,483.517v37.089l-3.64-3.39v-20.081c0-1.256-0.451-2.354-1.35-3.295
                                ...
                                <path fill="#fff" d="M-333.402,483.517v24.537c0.795,1.59,1.924,2.386,3.389,2.386c2.092,0,4.246-1.276,6.464-3.828
                        ...
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-476.62,471.518 -475.463,473.257
                      -474.594,476.056 -475.463,473.256 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-482.702,489.668 -482.605,491.407
                      -480,494.688 -482.605,491.406 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-479.166,515.252 -479.712,516.025
                      -479.709,516.024 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-492.163,439.08 -490.717,443.811
                      -489.943,454.044 -490.717,443.81 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-529.065,422.983 -529.065,422.984
                      -525.664,428.653 -519.677,431.356 -525.664,428.652 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                            points="-476.427,522.783 -478.743,522.59
                      -480.288,521.625 -478.744,522.59 -476.427,522.784 -473.919,523.942 -472.76,529.348 -473.916,523.941 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-476.522,534.658 -471.985,538.713
                      -469.571,541.899 -471.985,538.712 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-476.522,499.516 -472.76,501.544
                      ...
                      -491.487,466.016 -491.487,466.016 -490.135,470.167 -488.977,470.65 -485.214,470.167 -478.842,470.457 -485.214,470.166 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-456.25,588.046 -461.269,586.598
                      -462.228,585.343 -461.269,586.599 -456.25,588.047 -454.898,589.301 -454.897,589.301 ">
                        </polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-454.415,574.144 -451.807,575.207
                      -451.807,575.206 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-459.724,575.882 -466.677,581.674
                      ...
                      -456.828,574.53 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-459.344,618.748 -458.76,620.872
                      -456.44,623.864 -458.76,620.871 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-463.878,597.219 -463.188,598.763
                      -463.878,597.218 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-771.947,470.457 -771.947,470.456
                      -774.264,480.883 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-866.077,648.483 -859.223,653.117
                      -840.593,661.131 -859.222,653.117 "></polygon>
                        <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                            d="M-778.416,501.833l1.062-2.51L-778.416,501.833z"></path>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-777.354,499.323 -775.037,496.523
                      -773.492,490.73 -773.492,490.73 -775.037,496.522 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-779.673,520.563 -777.933,513.418
                      -777.643,508.881 -777.933,513.417 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                            points="-993.032,590.46 -989.75,595.481
                      ...
                      -983.378,599.342 -988.399,596.639 -989.75,595.48 -993.032,590.459 -993.998,586.985 -993.998,586.985 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-944.471,593.356 -948.236,591.425
                      ...
                      -942.83,594.708 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-924.293,619.616 -928.542,614.21
                      -924.293,619.617 -923.425,621.644 -923.425,621.643 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-938.003,601.176 -930.375,608.514
                      -928.542,614.21 -930.375,608.513 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                            points="-909.329,643.365 -913.77,640.469
                      -921.783,633.519 -913.77,640.47 -909.329,643.366 -904.791,645.49 -899.095,646.552 -904.791,645.489 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-974.593,603.107 -970.731,602.239
                      -957.311,595.866 -970.731,602.238 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-881.814,644.717 -899.095,646.552
                      -881.814,644.718 -876.215,645.201 -871.949,646.148 -876.215,645.2 "></polygon>
                        <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                            d="M-924.39,629.078l0.58,2.027L-924.39,629.078z"></path>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-798.615,364.172 -811.919,362.81
                      -816.041,362.81 -816.041,362.81 -811.919,362.81 "></polygon>
                        <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-791.258,354.507 -795.891,364.451
                      -795.89,364.451 "></polygon>

                        <g id="Mymensingh">
                            <a href="https://sc.banglastudent.com/division-details?slug=%E0%A6%AE%E0%A7%9F%E0%A6%AE%E0%A6%A8%E0%A6%B8%E0%A6%BF%E0%A6%82%E0%A6%B9-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97"
                                xlink:href="https://sc.banglastudent.com/division-details?slug=%E0%A6%AE%E0%A7%9F%E0%A6%AE%E0%A6%A8%E0%A6%B8%E0%A6%BF%E0%A6%82%E0%A6%B9-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97">
                                <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" d="M-576.735,362.713l-2.222,2.414l-1.256,0.676
                            ...
                            <g class="mymensingh-dev">
                                <path fill="#fff" d="M-750.923,436.688h-6.338v36.898l-1.38-1.381c-1.883-7.111-5.146-11.421-9.79-12.927
                                ...
                                <path fill="#fff" d="M-724.755,436.688v37.339c-0.963-0.711-2.259-2.512-3.891-5.397c-1.757-3.053-3.452-5.291-5.083-6.714
                                    ...
                                    "></path>
                                <path fill="#fff" d="M-684.78,436.688h-6.338v36.898l-1.38-1.381c-1.884-7.111-5.146-11.421-9.79-12.927
                                ...
                                <path fill="#fff" d="M-657.734,436.688v37.777l-2.761-1.758l0.251-3.702c0.042-3.974-0.878-8.116-2.762-12.425
                                ...
                                <path fill="#fff" d="M-615.564,428.905c-1.129-1.004-2.385-1.997-3.766-2.98c-1.381-0.981-2.949-1.955-4.706-2.918
                                ...
                                <path fill="#fff" d="M-583.937,442.335c0,2.134-0.732,4.058-2.197,5.773c-1.422,1.59-3.2,2.384-5.334,2.384
                        ...
                        <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" d="M-529.566,422.149l0.501,0.833
                      C-529.053,422.632-529.205,422.351-529.566,422.149z"></path>
                        <rect x="-529.316" y="422.08" fill="#103466" stroke="#fff" stroke-width="2"
                            stroke-miterlimit="10" width="0.001" height="0.974"></rect>

                        <g id="Rajshahi">
                            <a href="https://sc.banglastudent.com/division-details?slug=%E0%A6%B0%E0%A6%BE%E0%A6%9C%E0%A6%B6%E0%A6%BE%E0%A6%B9%E0%A7%80-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97"
                                xlink:href="https://sc.banglastudent.com/division-details?slug=%E0%A6%B0%E0%A6%BE%E0%A6%9C%E0%A6%B6%E0%A6%BE%E0%A6%B9%E0%A7%80-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97">
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10"
                            ...
                            <g class="rajshahi-dev">
                                ...
                                <path fill="#fff" d="M-962.136,511.033v36.711l-3.389-3.514v-26.043c0-1.089-0.209-2.071-0.627-2.949
                                    ...
                                    c0.418,2.511,1.149,4.31,2.195,5.397h2.511l3.452,3.514H-962.136L-962.136,511.033z">
                                </path>
                                <path fill="#fff" d="M-913.188,511.033h-20.082c-0.586,0.042-1.182,0.305-1.788,0.785s-0.951,0.973-1.036,1.475
                                ...
                                <path fill="#fff" d="M-881.561,511.033v36.962l-3.64-3.577l0.251-22.528c0-1.464-0.795-3.282-2.385-5.459
                                ...
                                <path fill="#fff" d="M-868.697,511.033v36.711l-3.389-3.514v-26.043c0-1.089-0.209-2.071-0.627-2.949
                                    ...
                                    c0.418,2.511,1.15,4.31,2.196,5.397h2.51l3.452,3.514H-868.697L-868.697,511.033z">
                                </path>
                                <path fill="#fff"
                                ...
                                <path fill="#fff" d="M-824.142,511.033v36.711l-3.451-3.514v-33.197h-5.146l-3.828-3.514h8.974
                        ...
                        <g id="Rangpur">
                            <a href="https://sc.banglastudent.com/division-details?slug=%E0%A6%B0%E0%A6%82%E0%A6%AA%E0%A7%81%E0%A6%B0-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97"
                                xlink:href="https://sc.banglastudent.com/division-details?slug=%E0%A6%B0%E0%A6%82%E0%A6%AA%E0%A7%81%E0%A6%B0-%E0%A6%AC%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%97">
                                <polygon fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" points="-766.155,245.605 -770.885,233.923
                                ...
                                <path fill="#103466" stroke="#fff" stroke-width="2" stroke-miterlimit="10" d="M-795.891,364.451l-2.724-0.279L-795.891,364.451
                                z"></path>
                            </a>
                            <g class="rangpur-dev">
                                <path fill="#fff"
                                ...
                                <path fill="#fff" d="M-906.545,251.636c0,2.134-0.732,4.058-2.197,5.773c-1.422,1.59-3.2,2.384-5.334,2.384
                                ...
                                <path fill="#fff" d="M-869.709,245.987v36.648l-3.766-3.64l0.502-18.764c0-0.543-0.125-1.139-0.376-1.788
                        ...
                        <g>
                            <path fill="#DB2028" d="M-359.575,434.156c0-10.679-8.656-19.333-19.335-19.333c-10.68,0-19.334,8.655-19.334,19.333
                                ...
                                s9.535,4.269,9.535,9.537s-4.269,9.537-9.535,9.537S-388.445,438.269-388.445,433.001z">
                            </path>
                        ...
                        <g>
                            <path fill="#DB2028" d="M-651.575,390.156c0-10.679-8.656-19.333-19.335-19.333c-10.68,0-19.334,8.655-19.334,19.333
                                ...
                                s9.535,4.269,9.535,9.537s-4.269,9.537-9.535,9.537S-680.445,394.269-680.445,389.001z">
                            </path>
                        ...
                        <g>
                            <path fill="#DB2028" d="M-879.575,200.156c0-10.679-8.656-19.333-19.335-19.333c-10.68,0-19.334,8.655-19.334,19.333
                                ...
                                s9.535,4.269,9.535,9.537s-4.269,9.537-9.535,9.537S-908.445,204.269-908.445,199.001z">
                            </path>
                        ...
                        <g>
                            <path fill="#DB2028" d="M-886.575,462.156c0-10.679-8.656-19.333-19.335-19.333c-10.68,0-19.334,8.655-19.334,19.333
                                ...
                                s9.535,4.269,9.535,9.537s-4.269,9.537-9.535,9.537S-915.445,466.269-915.445,461.001z">
                            </path>
                        ...
                        <g>
                            <path fill="#DB2028" d="M-267.575,933.156c0-10.68-8.656-19.334-19.335-19.334c-10.68,0-19.334,8.654-19.334,19.334
                                ...
                                s9.535,4.269,9.535,9.536s-4.269,9.537-9.535,9.537S-296.445,937.269-296.445,932.001z">
                            </path>
                        ...
                        <g>
                            <path fill="#DB2028" d="M-657.575,594.156c0-10.68-8.656-19.334-19.335-19.334c-10.68,0-19.334,8.654-19.334,19.334
                                ...
                                s9.535,4.269,9.535,9.536s-4.269,9.537-9.535,9.537S-686.445,598.269-686.445,593.001z">
                            </path>
                        ...
                        <g>
                            <path fill="#DB2028" d="M-644.575,913.156c0-10.68-8.656-19.334-19.335-19.334c-10.68,0-19.334,8.654-19.334,19.334
                                ...
                                s9.535,4.269,9.535,9.536s-4.269,9.537-9.535,9.537S-673.445,917.269-673.445,912.001z">
                            </path>
                        ...
                        <g>
                            <path fill="#DB2028" d="M-840.575,846.156c0-10.68-8.656-19.334-19.335-19.334c-10.68,0-19.334,8.654-19.334,19.334
                                ...
                                s9.535,4.269,9.535,9.536s-4.269,9.537-9.535,9.537S-869.445,850.269-869.445,845.001z">
                            </path>
...
<section class="filter-section py-3">
    <div class="container">
        ...
        {{-- <form id="location_search" action="{{ route('location_search') }}" method="GET" class="filter-form">
        <div class="input-wrapper">
            ...
            <select name="district_id" class="form-select">
                <option>জেলা</option>
                @foreach(App\Models\District::orderByDesc('id')->get() as $row)
                <option value="{{ $row->id }}">{{ $row->district_name ?? '' }}</option>
                @endforeach
            </select>
            <button type="submit" class="filter-btn">সার্চ করুন</button>
        </div>
        </form> --}}
    </div>
</section>

<section class="filter-section py-3" id="locationSearchResult">
    <div class="container">
                ...
                <div class="single-post">
                    ...
                    <figure class="image">
                        ...
                        <div class="price">
                            ...
                            @else
                            <del class="text-muted">{{ $post->monthly_tuition_fee ?? '' }} ৳</del>
                            @endif
                        </div>
                        <div class="absolute-bottom-right p-3">
                            <img class="lazyload img-contain rounded-2 bg-white" data-src="https://sc.banglastudent.com/public/frontend/images/icons/brac.png" width="40" height="40" alt="Logo">
                        </div>
                    </figure>
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="py-1 d-flex align-items-center gap-2">
                                        <span class="icon flex-shrink-0">
                                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="14"
                                                fill="currentColor" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                viewBox="0 0 90.4 122.9" style="enable-background:new 0 0 90.4 122.9;"
                                                xml:space="preserve">
                                                <g>
                                                    <path
                                        ...
                                        <span class="flex-grow-1 fs-16 fw-500 lh-1 pt-1">{{$post->maximum_seat ?? '' }}</span>
                                    </li>
                                    <li class="py-1 d-flex align-items-center gap-2">
                                        <span class="icon flex-shrink-0">
                                        ...
                                        <span class="flex-grow-1 fs-16 fw-500 lh-1 pt-1">{{ $post->shift->name ?? '' }}</span>
                                    </li>
                                    <li class="py-1 d-flex align-items-center gap-2">
                                        <span class="icon flex-shrink-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        ...
                                        <span class="flex-grow-1 fs-16 fw-500 lh-1 pt-1">
                                            @if($post->gender == 'both') {{ 'Male/Female' }} @elseif($post->gender == 'female')
...
<section class="featured-section py-3">
    <div class="container">
        <h3 class="h3 fw-600 text-secondary text-center mb-1">ফিচার্ড স্কুল/ কলেজ সমূহ</h3>
        <p class="text-center mb-4 fs-16">পছন্দের স্কুল/ কলেজ নির্বাচন করুন</p>
        <div class="row g-3">
            @foreach($featuredInstitute as $institute)
            <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <div class="d-flex flex-column justify-content-between h-100">
                        <div class="item-body">
                            <h6 class="h6 text-truncate-2 mb-3 text-dark"><a
                                    href="{{ route('institute_details',$institute->institute_slug) }}">{{ substr($institute->institute_name ?? '',0,200) }}</a>
                            </h6>
        ...
        <div class="text-center pt-4 mt-2">
            <a href="{{ route('all_top_institute') }}" class="btn btn-primary">আরো দেখুন</a>
        </div>
    </div>
</section>
...
<section class="latest-section py-3">
    <div class="container">
        <h3 class="h3 fw-600 text-secondary text-center mb-1">নতুন স্কুল/ কলেজ সমূহ</h3>
        <p class="text-center mb-4 fs-16">পছন্দের স্কুল/ কলেজ নির্বাচন করুন</p>
        <div class="row g-lg-3 g-3">
            @foreach($featuredInstitute as $institute)
            <div class="col-xl-3 col-lg-4 col-md-6">
...
<section class="py-3">
    <div class="container">
        <h2 class="h3 fw-600 text-secondary text-center mb-1">টপ ইনস্টিটিউট সমূহ</h2>
        <p class="text-center mb-4 fs-16">পছন্দের স্কুল/ কলেজ নির্বাচন করুন</p>
        <div class="carousel h-equal" data-arrows="true" data-items="4" data-xl-items="3" data-lg-items="2"
            data-sm-items="1" data-xs-items="1" data-autoplay="true" data-infinite="true">
            @foreach($topInstitute as $institute)
                ...
                <div class="single-post p-3 h-100">
                    <div class="d-flex flex-column justify-content-between h-100">
                        <div class="item-body">
                            ...
                            <div class="d-flex gap-3 mb-3">
                                <figure class="mb-0 flex-shrink-0">
                                    <img class="lazyload img-contain" width="70" height="70"
                                        data-src="@if($institute->logo) {{asset('public/uploads/'.$institute->logo)}} @else {{asset('public/frontend/images/icons/brac.png') }} @endif">
                                </figure>
                                <ul class="list-unstyled mb-0 row gx-0 gy-2 flex-grow-1 hov-content">
                                    @foreach($institute->post as $post)
            ...
            {{-- <div class="single-item p-10px">
                    <div class="single-post">
                        <h6 class="h6 mb-3 text-dark fw-500 text-truncate-2"><a
                                href="{{ route('institute_details',$institute->institute_slug) }}">{{$institute->institute_name ?? ''}}</a>
            </h6>
            <div class="item-body">
                <figure><img class="w-100 ratio-square img-contain"
                        src="@if($institute->logo) {{asset('public/uploads/'.$institute->logo)}} @else {{ asset('public/frontend/images/icons/brac.png') }} @endif"
                        alt="Logo"></figure>
            ...
            <div class="item-footer">
                ...
                <a href="{{ route('institute_details',$institute->institute_slug) }}" class="primary-btn">আরো
                    জানুন</a>
            </div>
        </div>
    </div> --}}
